...
<html lang="en">
  <head>
	...
	<link rel="icon" href="<?php echo base_url();?>/assets/admin/<?php echo base_url();?>/assets/admin/images/favicon.ico" type="image/ico" />
    ...
    <!-- NProgress -->
    <link href="<?php echo base_url();?>/vendor/nprogress/nprogress.css" rel="stylesheet">
    <!-- iCheck -->
    <link href="<?php echo base_url();?>/vendor/iCheck/skins/flat/green.css" rel="stylesheet">
	
    <!-- bootstrap-progressbar -->
    <link href="<?php echo base_url();?>/vendor/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="<?php echo base_url();?>/vendor/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link href="<?php echo base_url();?>/vendor/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
